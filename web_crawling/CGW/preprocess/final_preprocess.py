...
for year in years:
    path = f"C:/Users/NT550-052/OneDrive/바탕 화면/ASAC/프로젝트/ML/web_crawling/CGW/csvs/steam_store_df_{year}.csv"
    ...
    save_path = f"C:\\Users\\NT550-052\\OneDrive\\바탕 화면\\ASAC\\프로젝트\\ML\\web_crawling\\CGW\\csvs\\final\\steam_store_after_pcs_{year}.csv"
